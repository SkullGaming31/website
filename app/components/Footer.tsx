export default function Footer() {
  return (
    <footer className="w-full text-white mt-12" style={{ border: "5px solid #7c3aed" }}>
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-sm">© {new Date().getFullYear()} CanadienDragon — All rights reserved.</div>
