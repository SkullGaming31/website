    ...
    <section className="mt-12 mb-8 bg-gradient-to-r from-purple-700 via-purple-600 to-purple-500 rounded-xl p-6 text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Button href="https://discord.com/invite/6TGV75sDjW" external className="px-5 py-2" aria-label="Join Discord">
            Discord
          </Button>

          <Button href="https://twitter.com/SkullGamingHQ" variant="outline" className="px-5 py-2" aria-label="Twitter">
            Twitter
          </Button>

          <Button href="https://www.youtube.com/@SkullGamingHQ" variant="outline" className="px-5 py-2" aria-label="YouTube">
            YouTube
          </Button>
        </div>
      </div>
